...
def run_gpt_vague_incorrect_analysis(template_file: str | Path, reports_file: str | Path,
    ...
    for i, row in tqdm(df_reports.iterrows(), total=len(df_reports), desc="Processing reports"):
        ...
        #     continue
        # print(row["Pathologies"])
        template_params = {"pathologies": row["Pathologies"]}
...
if __name__ == "__main__":
    ...
    template_file = "./reportgen/prompt.txt"
    reports_file = "./reportgen/accession_pathologies.csv"
    output_dir = "./reportgen/experiment_1"
